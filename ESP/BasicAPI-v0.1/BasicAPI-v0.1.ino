...
// Route principale - Incrémente et affiche le compteur
void handleCount() {
    ...
    // Création d'un JSON avec la nouvelle valeur du compteur
    StaticJsonDocument<200> doc;
    doc["message"] = "Compteur mis à jour";
    doc["valeur"] = compteur;
...
void setup() {
    ...
    server.on("/", HTTP_GET, handleCount);
